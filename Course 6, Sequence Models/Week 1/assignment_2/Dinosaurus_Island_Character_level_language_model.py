...
def clip(
    ...
    Arguments:
        ...
        maxValue -- everything above this number is set to this number, and everything less
            than -maxValue is set to -maxValue
...
def sample(
    ...
    # idx is the index of the one-hot vector x that is set to . All other positions in
    # x are zero. Initialize idx to -1
    idx = -1
...
def model(
    ...
    for j in range(num_iterations):
        ...
        # Every 2000 Iteration, generate "n" characters thanks to sample() to check if
